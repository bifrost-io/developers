---
title: Soneium Integration
description: How to integrate with SLPX protocol on Soneium network
---
...
| Name | Value |
|---|---|
| Network Name | Soneium Network |
| Description | The public mainnet for Soneium Network. |
| Network URL | https://soneium.org/ |
| Explorer URL | https://soneium.blockscout.com/ |
